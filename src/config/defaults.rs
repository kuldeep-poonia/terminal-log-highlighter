...
pub fn default_config() -> Config {
    Config {
        filters: vec![
            ...
            Filter {
                pattern: "segfault".into(),
                severity: Severity::Critical,
            },
            Filter {
                pattern: "sigsegv".into(),
                severity: Severity::Critical,
            },
            Filter {
            ...
            Filter {
                pattern: "stacktrace".into(),
                severity: Severity::Error,
            },
            Filter {
                pattern: "stack trace".into(),
                severity: Severity::Error,
            },
            Filter {
                pattern: "failed".into(),
            ...
            Filter {
                pattern: "unhandled".into(),
                severity: Severity::Error,
            },
            Filter {
                pattern: "uncaught".into(),
                severity: Severity::Error,
            },
            ...
            Filter {
                pattern: "successfully".into(),
                severity: Severity::Info,
            },
            Filter {
                pattern: "started".into(),
                severity: Severity::Info,
            },
            Filter {
